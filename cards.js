            ...
            "conditionalEffects": [
                {
                    ...
                    "descriptionByStar": [
                        "敵防御力減少27% (低学年スキルが敵に命中するたび / 敵)",
                        "敵防御力減少31.5% (低学年スキルが敵に命中するたび / 敵)",
                        "敵防御力減少36% (低学年スキルが敵に命中するたび / 敵)",
                        "敵防御力減少40.5% (低学年スキルが敵に命中するたび / 敵)",
                        "敵防御力減少45% (低学年スキルが敵に命中するたび / 敵)"
                    ],
                    "bonusesByStar": [
                        {
                            "enemyDefDownP": 27
            ...
            "conditionalEffects": [
                {
                    "id": "catch_him_wave",
                    "type": "toggle",
                    "label": "1ウェーブ中 与ダメージ増加",
                    "shortLabel": "与ダメージ増加",
                    "description": "味方全体 / 倍率",
                    "descriptionByStar": [
                        "与ダメージ増加15% (1ウェーブ中 / 味方全体)",
                        "与ダメージ増加17.5% (1ウェーブ中 / 味方全体)",
                        "与ダメージ増加20% (1ウェーブ中 / 味方全体)",
                        "与ダメージ増加22.5% (1ウェーブ中 / 味方全体)",
                        "与ダメージ増加25% (1ウェーブ中 / 味方全体)"
                    ],
                    "bonusesByStar": [
                        {
                            "addP": 15
