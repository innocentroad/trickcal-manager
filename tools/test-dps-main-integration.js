...
assert.ok(main.includes('formation-damage-dps-prototype.css?v=20260828p'), '本体は共有DPS stylesheetの新cache-bustを参照する');
...
assert.match(cache, /calc: \[[\s\S]*formation-damage-dps-prototype\.css\?v=20260828p[\s\S]*dps-timing-data\.js\?v=20260827b[\s\S]*dps-simulator\.js\?v=20260827n[\s\S]*dps-support-registry\.js\?v=20260827c[\s\S]*formation-damage-dps-prototype\.js\?v=20260828h[\s\S]*\]/, '通常計算routeのcache warmupへDPS依存を加える');
